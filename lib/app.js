...
var CommentForm = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        "form",
        { action: "#", className: "commentForm", onSubmit: this.handleSubmit },
        React.createElement(
          "div",
          { className: "mdl-textfield mdl-js-textfield mdl-textfield--floating-label" },
          React.createElement("input", { className: "mdl-textfield__input", ref: "author", type: "text", id: "author" }),
          React.createElement(
            "label",
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("input", { className: "mdl-radio__button", ref: "kind3", id: "kind3", name: "kind", type: "radio", value: "twist" }),
            React.createElement(
              "span",
              { className: "mdl-radio__label" },
              "Twist"
        ...
        React.createElement(
          "button",
          { type: "submit", onclick: this.handleSubmit, className: "mdl-button mdl-js-button mdl-button--raised mdl-button--colored" },
          "Offer"
        )
      )
    );
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(CommentList, { kind: "appreciation", data: this.state.data })
                )
              ),
              React.createElement(
                "section",
                ...
                React.createElement(
                  "div",
                  { className: "page-content" },
                  React.createElement(CommentList, { kind: "simplifications", data: this.state.data })
                )
              ),
              React.createElement(
                "section",

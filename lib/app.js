...
var Comment = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "demo-card-event mdl-card mdl-shadow--2dp" },
        React.createElement(
          "div",
...
var CommentForm = React.createClass({
  ...
  getName: function getName(authData) {
  ...
  render: function render() {
    ...
    if (!this.state.authData) return React.createElement(
      "div",
      null,
      React.createElement(
        "button",
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("input", { className: "mdl-textfield__input", ref: "author", type: "text", id: "author", defaultValue: name }),
          React.createElement(
            "label",
            { className: "mdl-textfield__label", htmlFor: "author" },
            "Your Name"
          )
        ),
        React.createElement(
          "div",
          { className: "mdl-textfield mdl-js-textfield mdl-textfield--floating-label" },
          React.createElement("input", { className: "mdl-textfield__input", ref: "text", type: "text", id: "text" }),
          React.createElement(
            "label",
            { className: "mdl-textfield__label", htmlFor: "text" },
            "Appreciation"
          )
        ),
        React.createElement(
          "div",
          { className: "kinds", ref: "kinds" },
          React.createElement(
            "label",
            { className: "mdl-radio mdl-js-radio mdl-js-ripple-effect", htmlFor: "kind1" },
            React.createElement("input", { defaultChecked: true, className: "mdl-radio__button", ref: "kind1", id: "kind1", name: "kind", type: "radio",
              value: "appreciation" }),
            React.createElement(
              "span",
          ...
          React.createElement(
            "label",
            { className: "mdl-radio mdl-js-radio mdl-js-ripple-effect", htmlFor: "kind2" },
            React.createElement("input", { className: "mdl-radio__button", ref: "kind2", id: "kind2", name: "kind", type: "radio", value: "simplification" }),
            React.createElement(
              "span",
              { className: "mdl-radio__label" },
              "Simplification"
          ...
          React.createElement(
            "label",
            { className: "mdl-radio mdl-js-radio mdl-js-ripple-effect", htmlFor: "kind3" },
            React.createElement("input", { className: "mdl-radio__button", ref: "kind3", id: "kind3", name: "kind", type: "radio", value: "opportunity" }),
            React.createElement(
              "span",
              { className: "mdl-radio__label" },
              "Opportunity"
          ...
          React.createElement(
            "label",
            { className: "mdl-radio mdl-js-radio mdl-js-ripple-effect", htmlFor: "kind4" },
            React.createElement("input", { className: "mdl-radio__button", ref: "kind4", id: "kind4", name: "kind", type: "radio", value: "concern" }),
            React.createElement(
              "span",
              { className: "mdl-radio__label" },
              "Concern"
          ...
          React.createElement(
            "label",
            { className: "mdl-radio mdl-js-radio mdl-js-ripple-effect", htmlFor: "kind5" },
            React.createElement("input", { className: "mdl-radio__button", ref: "kind5", id: "kind5", name: "kind", type: "radio", value: "twist" }),
            React.createElement(
              "span",
              { className: "mdl-radio__label" },
              "Twist"
        ...
        React.createElement(
          "button",
          { onClick: this.handleSubmit, className: "mdl-button mdl-js-button mdl-button--raised mdl-button--colored" },
          "Offer"
        ),
        React.createElement(
          "button",
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(CommentList, { kind: "appreciation", url: this.props.url })
                )
              ),
              React.createElement(
                "section",
                ...
                React.createElement(
                  "div",
                  { className: "page-content" },
                  React.createElement(CommentList, { kind: "simplification", url: this.props.url })
                )
              ),
              React.createElement(
                "section",
                ...
                React.createElement(
                  "div",
                  { className: "page-content" },
                  React.createElement(CommentList, { kind: "opportunity", url: this.props.url })
                )
              ),
              React.createElement(
                "section",
                ...
                React.createElement(
                  "div",
                  { className: "page-content" },
                  React.createElement(CommentList, { kind: "concern", url: this.props.url })
                )
              ),
              React.createElement(
                "section",
                ...
                React.createElement(
                  "div",
                  { className: "page-content" },
                  React.createElement(CommentList, { kind: "twist", url: this.props.url })
                )
              ),
              React.createElement(
                "section",
...
ReactDOM.render(React.createElement(CommentBox, { url: "localhost:8080" }), document.getElementById('content'));
